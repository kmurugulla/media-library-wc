...
async function performEDSScan() {
  ...
  try {
    ...
    if (error.message.includes('CORS') || error.message.includes('cross-origin')) {
      ...
      errorMessage = 'Authentication Error: Please check your AEM credentials and permissions.';
    } else if (error.message.includes('404') || error.message.includes('Not Found')) {
      errorMessage = 'AEM API not found. Please verify your organization and repository names.';
    }
